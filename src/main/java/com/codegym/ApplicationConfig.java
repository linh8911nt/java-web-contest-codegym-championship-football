...
import com.codegym.formatter.TeamFormatter;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public void addFormatters(FormatterRegistry registry){
        registry.addFormatter(new TeamFormatter(applicationContext.getBean(TeamService.class)));
    }
...
//                .addResourceLocations("file:" + StorageUtils.FEATURE_LOCATION + "/");
    ...
    public DataSource dataSource(){
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/football?useUnicode=true&characterEncoding=utf8"  + "&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
